...
export const BUCKET_LIST: BucketItem[] = [
  ...
  { id: "b003", category: "romantic", rarity: "N",  emoji: "🌙", title: "一起去電影院看一場深夜首映", proofHint: "text" },
  ...
  { id: "b007", category: "romantic", rarity: "R",  emoji: "🎤", title: "一起去看喜歡的歌手/樂團演唱會", proofHint: "photo" },
  { id: "b008", category: "romantic", rarity: "N",  emoji: "🛐", title: "一起去廟裡或教堂祈福" },
  { id: "b009", category: "romantic", rarity: "N",  emoji: "🤫", title: "瞞著對方偷買他捨不得買的東西" },
  { id: "b010", category: "romantic", rarity: "R",  emoji: "🐬", title: "一起去海洋館看海豚與水母", proofHint: "photo" },
  { id: "b011", category: "romantic", rarity: "N",  emoji: "🎄", title: "一起逛聖誕耶誕城或燈會", proofHint: "location" },
  { id: "b012", category: "romantic", rarity: "SR", emoji: "💍", title: "策劃一場驚喜求婚或大型紀念日" },
  { id: "b013", category: "romantic", rarity: "N",  emoji: "📚", title: "去書店互選一本書給對方" },
  { id: "b014", category: "romantic", rarity: "R",  emoji: "📸", title: "去照相館拍一組情侶寫真", proofHint: "photo" },
  { id: "b015", category: "romantic", rarity: "N",  emoji: "📱", title: "戴上成套的情侶手機殼" },
  { id: "b016", category: "romantic", rarity: "R",  emoji: "💋", title: "在摩天輪最高點時親吻" },
  { id: "b017", category: "romantic", rarity: "N",  emoji: "🎨", title: "一起參觀一次畫展或博物館", proofHint: "location" },
  ...
  // ═══════════════════════════════════════ 三、戶外冒險 (15)
  { id: "b041", category: "outdoor", rarity: "N",  emoji: "🐚", title: "一起去海邊踏浪、撿貝殼",         proofHint: "location" },
  { id: "b042", category: "outdoor", rarity: "SR", emoji: "🪂", title: "嘗試一次高空彈跳或跳傘",         proofHint: "photo" },
  { id: "b043", category: "outdoor", rarity: "R",  emoji: "🏕️", title: "一起去深山裡露營看滿天星斗",     proofHint: "location" },
  { id: "b044", category: "outdoor", rarity: "R",  emoji: "🚴", title: "一起騎自行車環河或環島",         proofHint: "photo" },
  { id: "b045", category: "outdoor", rarity: "SR", emoji: "🤿", title: "一起去潛水看海底的世界",         proofHint: "photo" },
  { id: "b046", category: "outdoor", rarity: "R",  emoji: "🥾", title: "共同完成一次長途爬山健行",       proofHint: "location" },
  { id: "b047", category: "outdoor", rarity: "R",  emoji: "🚗", title: "來場說走就走的自駕旅行",         proofHint: "location" },
  { id: "b048", category: "outdoor", rarity: "SR", emoji: "⛷️", title: "一起去滑雪或嘗試溜冰",           proofHint: "photo" },
  { id: "b049", category: "outdoor", rarity: "N",  emoji: "🦒", title: "一起去動物園餵食可愛小動物",     proofHint: "location" },
  { id: "b050", category: "outdoor", rarity: "N",  emoji: "🌲", title: "一起去森林深呼吸享受芬多精" },
  { id: "b051", category: "outdoor", rarity: "N",  emoji: "🍓", title: "一起採草莓、摘橘子等農家體驗",   proofHint: "photo" },
  { id: "b052", category: "outdoor", rarity: "N",  emoji: "📮", title: "在不同城市收集當地明信片",       proofHint: "text" },
  { id: "b053", category: "outdoor", rarity: "R",  emoji: "🏃", title: "一起跑一次路跑或馬拉松",         proofHint: "photo" },
  { id: "b054", category: "outdoor", rarity: "SR", emoji: "✈️", title: "嘗試一次在異國街頭擁吻",         proofHint: "location" },
  { id: "b055", category: "outdoor", rarity: "R",  emoji: "🚣", title: "一起划獨木舟或 SUP 立槳",       proofHint: "photo" },
  ...
  { id: "b074", category: "playful", rarity: "N",  emoji: "🎤", title: "KTV 唱那首你們的主題曲", proofHint: "text" },
  ...
  { id: "b085", category: "tender", rarity: "R",  emoji: "♨️", title: "一起去泡一次溫泉", proofHint: "location" },
  { id: "b086", category: "tender", rarity: "N",  emoji: "💋", title: "在人群中大方親吻對方的臉頰" },
  { id: "b087", category: "tender", rarity: "R",  emoji: "🕯️", title: "為對方準備一次浪漫的燭光晚餐" },
  { id: "b088", category: "tender", rarity: "N",  emoji: "🌅", title: "一起追一場日出", proofHint: "photo" },
  ...
  { id: "b094", category: "tender", rarity: "R",  emoji: "🎆", title: "一起看一場煙火大會", proofHint: "photo" },
  { id: "b095", category: "tender", rarity: "SR", emoji: "🫂", title: "失落時給對方一個安靜且長久的擁抱" },
  { id: "b096", category: "tender", rarity: "R",  emoji: "🌸", title: "一起看一次櫻花盛開", proofHint: "photo" },
  { id: "b097", category: "tender", rarity: "R",  emoji: "🧩", title: "共同完成一套 1000 片的拼圖" },
  { id: "b098", category: "tender", rarity: "N",  emoji: "🏥", title: "陪對方去醫院看醫生或做檢查" },
  { id: "b099", category: "tender", rarity: "SSR", emoji: "💒", title: "領取結婚證，正式結為夫妻", proofHint: "photo" },
